# CAIE Submission Package (Teacher-Distilled HGNN Draft)
...
**Authors:** [Author 1], [Author 2], ... (add names/affiliations)

**Corresponding author:** [Name], [Email], [Institution], [Address]
...
| Industrial/semi-real validation | Not done | Required for a strong CAIE submission |
| Author/title page | Placeholder | Fill before submission |
| Repository URL | Placeholder | Replace [repository placeholder] |

## Submission Files Checklist (Elsevier CAIE)

| File | Status | Notes |
|---|---|---|
| Manuscript (Word/LaTeX) | `JSP_RL_Paper_L2D_Distill.docx` | Revised draft, not yet submission-ready |
| Cover Letter | `CAIE_Cover_Letter.md` | Updated to teacher-distillation framing |
...
## Required Work Before CAIE Submission

1. Decide whether CAIE is the right venue for a teacher-student distillation
